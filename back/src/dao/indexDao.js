...
exports.deleteStudent = exports.exampleDao = async function (connection, studentIdx) {
...
exports.selectStudents = async function (connection, studentName) {
  ...
  const selectStudentByName = `SELECT * FROM Students where studentName = ?;`;
  const Params = [studentName];
  
  let Query = studentName ? selectStudentByName : selectAllStudentsQuery;
